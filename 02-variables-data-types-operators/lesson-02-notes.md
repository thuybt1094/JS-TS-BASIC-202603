...
Tư duy đọc code. Trước khi hỏi AI, hay add console.log, debug -> chúng ta
nên áp dụng tư duy đọc code từ trên xuống để hiểu đc logic
...
hàm . console.log(i++)
điều điện if(i++ > 5)
ĐIỂM MẤU CHỐT : NƠI ĐANG DÙNG NÓ LUÔN NHẬN GIÁ TRỊ CỦA CẢ BIỂU THỨC, chứ ko phải cứ nhìn
bién sau cùng là đủ
