...
//ccascj 3: Constructor ko tham số - dùng class fields thuần
...
///TH2: this ở trong method ->  object đnag gọi method đó
...
//TH3; This bị mất khi nso nằm trong callback (hàm thường)
class DashBoard {
  tieuDe = "trangChu";
...
class ProductPage {
    ...
    constructor() {
    // khai báo như vậy là không nên. Khi nào cần thay đổi mới đưa vào constructor
...
product.thucHienThemVaKiemTra('Áo thun', 250000);